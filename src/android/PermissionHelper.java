...
/**
 * This class provides reflective methods for permission requesting and checking
 * so that plugins written for cordova-android 5.0.0+ can still compile with
 * earlier cordova-android versions.
 */
public class PermissionHelper {
	private static final String LOG_TAG = "CordovaPermissionHelper";

	/**
	 * Requests a "dangerous" permission for the application at runtime. This is
	 * a helper method alternative to cordovaInterface.requestPermission() that
	 * does not require the project to be built with cordova-android 5.0.0+
	 *
	 * @param plugin
	 *            The plugin the permission is being requested for
	 * @param requestCode
	 *            A requestCode to be passed to the plugin's
	 *            onRequestPermissionResult() along with the result of the
	 *            permission request
	 * @param permission
	...
	/**
	 * Requests "dangerous" permissions for the application at runtime. This is
	 * a helper method alternative to cordovaInterface.requestPermissions() that
	 * does not require the project to be built with cordova-android 5.0.0+
	 *
	 * @param plugin
	 *            The plugin the permissions are being requested for
	 * @param requestCode
	 *            A requestCode to be passed to the plugin's
	 *            onRequestPermissionResult() along with the result of the
	 *            permissions request
	 ...
	 * permission. This is a helper method alternative to
	 * cordovaInterface.hasPermission() that does not require the project to be
	 ...
	 * @return True if the permission has already been granted and false
	 *         otherwise
	 */
